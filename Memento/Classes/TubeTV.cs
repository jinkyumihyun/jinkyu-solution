...
{
    internal class TubeTV : ITV
    {
        public string Size { get; set; }
        public string Price { get; set; }
        public bool USBSupport { get; set; }
        private TubeTV(string Size, string Price, bool USBSupport) =>      
       ...
       => (Helper.IsNullWhite(Size), Helper.IsNullWhite(Price)) switch
       {
           ...
           (_, _) => new TubeTV(Size, Price, USBSupport)
       };
        public ITV Clone() => (ITV)this.MemberwiseClone();
        public string GetDetails() => $"TubeTV [Size = {Size}; Price = {Price}; USBSupport = {USBSupport}]";
    }
}
